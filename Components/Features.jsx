    ...
    <section id="features" className="relative overflow-hidden bg-white py-24">
      ...
      <div className="relative mx-auto px-6 lg:px-10">
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#fef3c7]">
                <feature.icon size={30} className="text-[#b8860b]" />
              </div>
              ...
              <div className="mt-8 h-1 w-16 rounded-full bg-[#0f766e]"></div>
            </motion.div>
          ))}
        </div>
        ...
        >
          ...
          <a
            href="#programs"
            className="mt-10 inline-block rounded-full bg-[#0f766e] px-8 py-4 font-semibold text-white hover:bg-[#115e59]"
          >
            Explore Academics
          </a>
        </motion.div>
